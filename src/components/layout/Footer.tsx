        ...
        <footer className="bg-charcoal text-warm-white">
              <div className="border-b border-white/10 bg-pine-green py-16">
                      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
                                ...
                                <div className="mt-8">
                                            <Button href="/contact">Request Your Free Consultation</Button>Button>
                                </div>div>
                      </div>div>
              </div>div>
          ...
          {/* Made in America Banner */}
              <div className="border-b border-white/10 bg-[#1a1a2e] py-6">
                      <div className="mx-auto flex max-w-7xl items-center justify-center gap-5 px-6 lg:px-8">
                                <span
                                              className="relative h-10 w-16 flex-shrink-0 overflow-hidden rounded-sm border border-white/40 bg-[repeating-linear-gradient(to_bottom,#b22234_0,#b22234_2px,#fff_2px,#fff_4px)]"
                                              aria-hidden="true"
                                            >
                                            <span className="absolute left-0 top-0 h-[54%] w-[42%] bg-[#3c3b6e]" />
                                </span>span>
                                <span className="font-heading text-2xl font-bold uppercase tracking-[0.2em] text-warm-white md:text-3xl">
                          ...
                          <li key={service.slug}>
                                ...
                                <div>
                                            ...
                                            <address className="mt-4 space-y-2 text-sm not-italic text-warm-white/70">
                                                          <p>Headquarters: {CONTACT.headquarters}</p>p>
                                                          <p>Service Area: {CONTACT.serviceArea}</p>p>
                                                          <p>
